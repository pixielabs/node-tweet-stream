...
Twitter.prototype.sample = function() {
  ...
  this._filters[FILTER_TYPE_TRACKING] = {}
  this._filters[FILTER_TYPE_LOCATION] = {}
  this._filters[FILTER_TYPE_FOLLOW] = {}
...
Twitter.prototype.connect = function () {
  ...
  if (Object.keys(this._filters[FILTER_TYPE_TRACKING]).concat(Object.keys(this._filters[FILTER_TYPE_LOCATION]), Object.keys(this._filters[FILTER_TYPE_FOLLOW])).length === 0) {
    method = 'get'
  }
  this.stream = request[method]({
    url: method === 'post' ? this.twitterUrl : 'https://stream.twitter.com/1.1/statuses/sample.json'
    oauth: this.oauth,
    form: {
